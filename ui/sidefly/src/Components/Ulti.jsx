...
function Ulti() {
    ...
    let [check1IntId, setCheck1IntId] = useState(null)
    ...
    function startCheck1(){
        let checkIntervalId = setInterval(newEntriesRequiredCheck, 500)
        setCheck1IntId(checkIntervalId);
    }
    function stopCheck1() {
        clearInterval(check1IntId);
        // clearInterval(count);
    ...
    function startCheck() {
        // count = setInterval(stratCheck, 1000)
        let checkIntervalId = setInterval(stratCheck, 500)
